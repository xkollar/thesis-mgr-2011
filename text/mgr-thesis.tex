...
Defining classes creates new kind constants, instances fills them.

Intersection have sense (understand possibility of not-emptiness) only
on kinds with same sort (\(\texttt{Eq} \cap \texttt{Functor}\) feels wrong
on first sight).
