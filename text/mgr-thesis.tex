...
Standard Prelude \(\kindStar\) classes and how they are structured is
...
\begin{figure}
	...
	\caption{Explicit ``star'' Prelude classes}
\end{figure}
...
\begin{figure}
	...
	\caption{Alternative view for some ``star'' classes}
\end{figure}
...
\begin{figure}
	...
	\caption{Some ``emptyset to star'' classes}
\end{figure}
